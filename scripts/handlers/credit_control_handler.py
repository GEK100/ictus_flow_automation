"""Handler: Credit Control.

Routes classified credit control documents through chase letter generation.
"""
...
def process(file_path, client_config):
    """Process a credit control document.
    ...
    tmpdir = os.path.join(
        ...
        f'credit-control-{uuid.uuid4().hex[:8]}',
    )
    os.makedirs(tmpdir, exist_ok=True)
    try:
        # TODO: Implement credit control pipeline
        pass
    finally:
