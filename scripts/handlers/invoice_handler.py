"""Handler: Invoice Processing.

Routes classified invoices through extraction, validation, and filing.
"""
...
def process(file_path, client_config):
    ...
    tmpdir = os.path.join(
        ...
        f'invoice-{uuid.uuid4().hex[:8]}',
    )
    os.makedirs(tmpdir, exist_ok=True)
    try:
        # TODO: Implement invoice processing pipeline
        pass
    finally:
